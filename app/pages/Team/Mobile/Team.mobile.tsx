...
const TeamMobile: React.FC = () => {
  ...
  return (
    <>
      ...
      <SectionWithStars className="hero-header-gap px-5 py-8 sm:px-6 bg-background-light dark:bg-background-dark overflow-hidden" settings={{ density: 0.47 }}>
        <div className="relative z-10 space-y-3">
          ...
          <h1 className="text-3xl font-black leading-tight text-slate-900 dark:text-white uppercase tracking-tight">{t('team.hero.title')}</h1>
          <p className="text-base text-slate-600 dark:text-slate-300 leading-relaxed font-medium">{t('team.hero.description')}</p>
          <div className="flex justify-end">
            <ButtonLink
              href="/contact"
              tone="dark"
              className="inline-flex items-center gap-2 rounded-xl uppercase tracking-widest text-xs px-5 py-3 shadow-lg focus:ring-2 focus:ring-secondary/40 focus:ring-offset-2 focus:ring-offset-background-light dark:focus:ring-offset-background-dark font-black"
            >
              {t('team.hero.cta')}
      ...
      <SectionWithStars className="px-4 py-6 bg-background-light dark:bg-background-dark overflow-hidden" settings={{ density: 0.5 }}>
        <div className="relative z-10 space-y-2">
          {teamMembers.map((member) => (
            <div key={member.id}>
              ...
              >
                <article className="flex flex-row items-center gap-3 rounded-3xl border border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-900/60 p-3 sm:p-4 shadow-sm transition-shadow hover:shadow-lg">
                  ...
                  <div className="relative shrink-0 w-[110px] h-[150px] rounded-2xl border border-slate-100 dark:border-slate-800 overflow-hidden shadow-sm">
                    <Image
                      src={member.imageSrc}
      ...
      <SectionWithStars className="px-5 py-8 sm:px-6 bg-primary text-white text-center" settings={{ density: 0.47 }}>
        <div className="relative z-10 space-y-2">
